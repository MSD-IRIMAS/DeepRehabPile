...
class ConvLSTM_REGRESSOR(BASE_REGRESSOR):
    """Depp Conv-LSTM regressor.
    ...
    def _build_model(self, return_model: bool = False, compile_model: bool = True):
        ...
        output_layer = tf.keras.layers.Dense(units=1, activation="linear")(lstm2)
