...
class H_Inception_REGRESSOR(BASE_REGRESSOR):
    """Define Hybrid Inception Regressor.

    This class implements a Hybrid Inception network-based regressor
    ...
    def __init__(
        ...
        self.regressor = IndividualInceptionRegressor(
            depth=self.depth,
