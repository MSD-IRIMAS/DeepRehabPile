...
__all__ = ["tAPE", "Attention_Rel_Scl", "MySqueezeLayer", "ConvTran_REGRESSOR"]
...
class ConvTran_REGRESSOR(BASE_REGRESSOR):
    """Define Convolutional Transformer Regressor.

    This class implements a convolutional transformer-based regressor
    proposed in [1]_.
