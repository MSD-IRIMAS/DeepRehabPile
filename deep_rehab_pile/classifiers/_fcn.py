...
class FCN_CLASSIFIER(BASE_CLASSIFIER):
    """Define Fully Convolutional Network (FCN) Classifier.

    This class implements a fully convolutional network-based classifier
    proposed in [1]_.
