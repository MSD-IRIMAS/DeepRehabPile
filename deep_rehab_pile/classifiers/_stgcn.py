...
__all__ = ["GCNLayer", "MySqueezeLayer", "STGCN_CLASSIFIER"]
...
class STGCN_CLASSIFIER(BASE_CLASSIFIER):
    """Define STGCN Classifier.

    This class implements a  Spatio-Temporal Graph
    Convolution Network based classifier proposed in [1]_
    ...
    kinematic_tree: list,
        The kinematic tree detailing the connections
        between all joints in the skeleton.
        The format should be a list of lists.
        Ex: [[0, 1, 2, 3],
             [0, 4, 5, 6]]
        Meaning that joint 0 is connected to joint 1
        which is connected to joint 2 etc.
