"""LITE Multivariate classifier."""

__all__ = ["LITE_MV_CLASSIFIER"]
...
class LITE_MV_CLASSIFIER(BASE_CLASSIFIER):
    """Define LITE Multivariate Classifier.

    This class implements a LITE Multivariate network-based classifier
    proposed in [1]_.
